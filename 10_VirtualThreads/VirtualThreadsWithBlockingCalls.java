...
public class VirtualThreadsWithBlockingCalls {
    ...
    public static class BlockingTask implements Runnable {
        ...
        @Override
        public void run() {
            System.out.println("Inside thread: " + Thread.currentThread() + " before blocking the call");
            try {
                Thread.sleep(1000);
            } catch (InterruptedException e) {
                throw new RuntimeException(e);
            }
            System.out.println("Outside thread: " + Thread.currentThread() + " after blocking call");
        }
